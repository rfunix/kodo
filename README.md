...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-2700%2B%20passing-brightgreen" alt="Tests: 2700+ passing">
...
| [`set_operations.ko`](examples/set_operations.ko) | `Set<T>` — `Set::new`, `add`, `contains`, `remove`, `length`, `union`, `intersection`, `difference` |
